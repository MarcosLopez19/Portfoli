...
ALTER TABLE entitatbancaria.centralsindical add quantitatEmpleats int default 0 after nomCen;
...
ALTER TABLE entitatbancaria.categoria modify nomCat VARCHAR(45) not null unique ;
ALTER TABLE entitatbancaria.categoria modify horaExtra DECIMAL(8,2) default 30.00;
...
alter table entitatbancaria.empleat add souAnual double(8,2) default 0 check(souAnual>0);
ALTER TABLE entitatbancaria.empleat DROP COLUMN souAnual;
...
INSERT INTO entitatbancaria.categoria VALUES (1, 'director', 2000, 50),
                                             ...
                                             (3, 'caixer', 1100, 12);
UPDATE entitatbancaria.categoria SET souBase=souBase*1.03,horaExtra=horaExtra*.05;
...
INSERT INTO entitatbancaria.empleat VALUES (12,'22222222A', 'Marta', 'Casillas', 1, NULL,1, 1);
...
INSERT INTO entitatbancaria.titol VALUES (1, 'Llicenciat en Economiques'), 
                                         ...
                                         (4, 'Administratiu'), 
                                         (5, 'Master ESADE');
UPDATE entitatbancaria.titol SET nomTit=UPPER(nomTit);
...
INSERT INTO entitatbancaria.titulacions VALUES (1,1,'1992-07-01'), (1,2,'1997-07-01'), (2,3,'2005-07-01'), (3,3,'1991-07-01'), (4,4,'1988-07-01'),
                                               ...
                                               (10,5,'1990-07-01');
UPDATE entitatbancaria.titucodTitlacions SET codCen=1;
drop table entitatbancaria.titulacions;
delete from entitatbancaria.titulacions; 
select*from entitatbancaria.empleat